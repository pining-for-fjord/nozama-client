...
/***/ (function(module, exports, __webpack_require__) {
	...
	var cartsEvents = __webpack_require__(12);
	var productsEvents = __webpack_require__(37);
	var ordersEvents = __webpack_require__(42);

	$(function () {
	  authEvents.addHandlers();
	  cartsEvents.addHandlers();
	  cartsEvents.hideCart();
	  productsEvents.addHandlers();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var userApi = __webpack_require__(9);
	var userUi = __webpack_require__(11);
	var getFormFields = __webpack_require__(36);
	var store = __webpack_require__(10);

	var onSignUp = function onSignUp(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  userApi.signUp(data).then(userUi.signUpSuccess).catch(userUi.signUpFailure);
	};
	var onSignIn = function onSignIn(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  userApi.signIn(data).then(userUi.signInSuccess).catch(userUi.signInFailure);
	};
	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  var cartEvents = __webpack_require__(12);
	  var id = store.cart._id;
	  cartEvents.deleteCart(id);
	  userApi.signOut().then(userUi.signOutSuccess).catch(userUi.signOutFailure);
	};

	var onChgPswd = function onChgPswd(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  userApi.chgPswd(data).then(userUi.chgPswdSuccess).catch(userUi.chgPswdFailure);
	};

	// **********************

	var linkSignUp = function linkSignUp() {
	  $('.sign-in').hide();
	  $('.sign-up').show();
	  // $('.dropdown-menu').click(stopPropagation)
	};

	var linkSignIn = function linkSignIn() {
	  $('.sign-up').hide();
	  $('.sign-in').show();
	  // $('.dropdown-menu').click(stopPropagation)
	};

	var linkChangePassword = function linkChangePassword() {
	  $('.sign-out').hide();
	  $('.change-password').show();
	  // $('.dropdown-menu').click(stopPropagation)
	};

	var linkAccount = function linkAccount() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var chgPswd = function chgPswd(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var chgPswdSuccess = function chgPswdSuccess() {
	...
	var chgPswdFailure = function chgPswdFailure() {
	  $('.dropdown-menu').trigger('click');
	...
	module.exports = {
	  ...
	  chgPswdSuccess: chgPswdSuccess,
	  chgPswdFailure: chgPswdFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showCartTemplate = __webpack_require__(15);
	...
	var createCart = function createCart() {
	  ...
	  api.create(data).then(ui.onCreateCartSuccess).catch(ui.onCreateCartFailure);
	};
	...
	var showCart = function showCart(cartData) {
	  $('.about__section').hide();
	  $('#cart').show();
	  $('#landing').hide();
	  $('#products').hide();
	  ...
	  var showProductsHTML = showCartTemplate({
	    cart: cartData
	  });
	  $('.fullCart').empty();
	...
	var addToCart = function addToCart(data) {
	  ...
	  var newTotalPrice = store.cart.totalPrice += data.price;
	  ...
	  api.update(params, 'add').then(ui.onAddToCartSuccess).catch(ui.onAddToCartFailure);
	};

	var removeFromCart = function removeFromCart(id) {
	  for (var i = 0; i < store.cart.products.length; i++) {
	    if (id === store.cart.products[i]._id) {
	      var data = store.cart.products[i];
	      var newTotalPrice = store.cart.totalPrice -= data.price;
	      store.cart.totalPrice = newTotalPrice;
	      var params = {
	        cart: {
	      ...
	      api.update(params, 'remove').then(ui.onUpdateCartSuccess).catch(ui.onUpdateCartFailure);
	    }
	  }
	};
	...
	function removeItem(removeButton) {
	  ...
	  var id = $(removeButton).parent().parent().attr('id');
	...
	var onGetCart = function onGetCart() {
	  if (!store.user || jQuery.isEmptyObject(store.user)) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var update = function update(data, action) {
	  return $.ajax({
	    url: config.apiOrigin + '/carts/' + store.cart._id,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateCartFailure = function onCreateCartFailure(error) {
	  console.log(error);
	};

	var onUpdateCartSuccess = function onUpdateCartSuccess(data) {};

	var onAddToCartSuccess = function onAddToCartSuccess(data) {
	  $('.cartItem').empty();
	  $('.cartItem').text(store.addedItem);
	  $('#addItem').modal('show');
	};

	var onUpdateCartFailure = function onUpdateCartFailure(error) {
	  if (error.status === 404) {
	    $('#alreadyInCart').modal('show');
	  }
	};

	var deleteCartSuccess = function deleteCartSuccess(data) {
	  store.cart = null;
	};

	var deleteCartFailure = function deleteCartFailure(error) {
	  console.log(error);
	};
	...
	var onAddToCartFailure = function onAddToCartFailure(error) {
	  $('#duplicateCartItem').modal('show');
	};

	module.exports = {
	  onCreateCartSuccess: onCreateCartSuccess,
	  onCreateCartFailure: onCreateCartFailure,
	  onUpdateCartSuccess: onUpdateCartSuccess,
	  onUpdateCartFailure: onUpdateCartFailure,
	  deleteCartSuccess: deleteCartSuccess,
	  deleteCartFailure: deleteCartFailure,
	  onGetCartSuccess: onGetCartSuccess,
	  onAddToCartSuccess: onAddToCartSuccess,
	  onAddToCartFailure: onAddToCartFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"product\" id =\""
	    ...
	    + alias2(__default(__webpack_require__(35)).call(alias3,(depth0 != null ? depth0.price : depth0),{"name":"decimal","hash":{},"data":data}))
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.cart : depth0)) != null ? stack1.products : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var prodApi = __webpack_require__(38);
	var prodUi = __webpack_require__(39);

	var getProducts = function getProducts(event) {
	  var category = $(this).attr('id');
	  prodApi.index(category).then(prodUi.getProductsSuccess).catch(prodUi.getProductsFailure);
	};

	var getProduct = function getProduct(prodId) {
	  prodApi.show(prodId).then(prodUi.getProductSuccess).catch(prodUi.getProductFailure);
	};

	var hideProduct = function hideProduct() {
	  $('#product').hide();
	};
	...
	var returnHomeButton = function returnHomeButton(event) {
	  event.preventDefault();
	  $('#checkout-container').hide();
	  $('#products').hide();
	  $('#cart').hide();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var index = function index(categoryName) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showProductsTemplate = __webpack_require__(40);
	...
	var getProductsSuccess = function getProductsSuccess(data) {
	  ...
	  var showProductsHTML = showProductsTemplate({
	  ...
	  $('.browse-products').on('click', function () {
	    event.preventDefault();
	    var result = $.grep(products.products.products, function (e) {
	...
	var getProductsFailure = function getProductsFailure(error) {
	  log;
	};

	var getProductSuccess = function getProductSuccess(product) {
	  store.product = product;
	};

	var getProductFailure = function getProductFailure(product) {};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"card-wrapper col-md-3 col-sm-6 animated zoomIn\">\n  <div class=\"card\">\n  <div class=\"image-wrapper\">\n"
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.image : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    ...
	    + "</h3>\n    </div>\n    <div class=\"price\">\n      $"
	    + alias3(__default(__webpack_require__(35)).call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.price : stack1),{"name":"decimal","hash":{},"data":data,"blockParams":blockParams}))
	    + "\n    </div>\n    <div class=\"description\">\n      "
	    + alias3(alias2(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "\n      "
	    + alias3(alias2(((stack1 = blockParams[0][0]) != null ? stack1.brand : stack1), depth0))
	    + "\n      "
	    + alias3(alias2(((stack1 = blockParams[0][0]) != null ? stack1.category : stack1), depth0))
	    + "\n    </div>\n    <div class=\"actions\">\n      <form id=\""
	    + alias3(alias2(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">\n        <input id=\""
	    + alias3(alias2(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\" type=\"submit\" class=\"button flip green-solid cart browse-products\" value=\"Add to Cart\">\n      </form>\n    </div>\n  </div>\n</div>\n</div>\n";
	  ...
	  return "      <img src=\""
	    ...
	    return "      <img src=\"http://placehold.it/800x500\" alt=\"\" class=\"image\" />\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.products : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ordersApi = __webpack_require__(43);
	var ordersUi = __webpack_require__(44);
	var store = __webpack_require__(10);
	var prod = __webpack_require__(37);

	var getOrders = function getOrders() {
	  ordersApi.index().then(ordersUi.getOrdersSuccess).catch(ordersUi.getOrdersFailure);
	  $('#landing').hide();
	  $('#products').hide();
	  $('#cart').hide();
	  $('#checkout-container').hide();
	...
	var getOrder = function getOrder(orderId) {
	  ordersApi.show(orderId).then(ordersUi.getOrderSuccess).catch(ordersUi.getOrderFailure);
	};

	var checkout = function checkout(event) {
	  var handler = StripeCheckout.configure({
	    ...
	    token: function token(_token) {
	      ...
	      ordersApi.create(order, tok).then(ordersUi.createOrderSuccess).catch(ordersUi.createOrderFailure);
	    }
	  });
	  handler.open({
	    name: 'Nozama',
	...
	var hideOrder = function hideOrder() {
	  $('#order').hide();
	  $('#checkout-container').hide();
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var create = function create(data, stripeToken) {
	  return $.ajax({
	    url: config.apiOrigin + '/orders',
	    method: 'POST',
	    data: data,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showOrdersTemplate = __webpack_require__(45);

	var getOrdersSuccess = function getOrdersSuccess(data) {
	  store.orders = data.orders;
	  var showOrdersHTML = showOrdersTemplate({
	    orders: data.orders
	  });
	  $('#order').empty();
	...
	var getOrdersFailure = function getOrdersFailure(error) {
	  console.log(error);
	};
	...
	var getOrderFailure = function getOrderFailure(error) {
	  console.log(error);
	};

	var createOrderSuccess = function createOrderSuccess() {
	  var cartApi = __webpack_require__(12);
	  cartApi.deleteCart();
	  cartApi.createCart();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"orderHistory\">\n<table class=\"table table-bordered tablebilling\">\n  <thead class=\"thead-inverse\">\n    <tr>\n      <th>Order Date</th>\n      <th>Shipped to</th>\n      <th>Address</th>\n      <th>City</th>\n      <th>State</th>\n      <th>Zip</th>\n      <th>Country</th>\n      <th>Total Price</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td>"
	    + alias2(__default(__webpack_require__(46)).call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.createdAt : stack1),{"name":"date","hash":{},"data":data,"blockParams":blockParams}))
	    + "</td>\n      <td>"
	    + alias2(alias3(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.shippingAddress : stack1)) != null ? stack1.recipientName : stack1), depth0))
	    + "</td>\n      <td>"
	    + alias2(alias3(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.shippingAddress : stack1)) != null ? stack1.address : stack1), depth0))
	    + "</td>\n      <td>"
	    + alias2(alias3(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.shippingAddress : stack1)) != null ? stack1.city : stack1), depth0))
	    + "</td>\n      <td>"
	    + alias2(alias3(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.shippingAddress : stack1)) != null ? stack1.state : stack1), depth0))
	    + "</td>\n      <td>"
	    + alias2(alias3(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.shippingAddress : stack1)) != null ? stack1.zip : stack1), depth0))
	    + "</td>\n      <td>"
	    + alias2(alias3(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.shippingAddress : stack1)) != null ? stack1.country : stack1), depth0))
	    + "</td>\n      <td>$"
	    + alias2(__default(__webpack_require__(35)).call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.totalPrice : stack1),{"name":"decimal","hash":{},"data":data,"blockParams":blockParams}))
	    + "</td>\n    </tbody>\n  </table>\n<table class=\"table table-bordered tableproducts\">\n  <thead class=\"thead-inverse\">\n    <tr>\n      <th>Products</th>\n      <th>Price</th>\n    </tr>\n  </thead>\n"
	    + ((stack1 = helpers.blockHelperMissing.call(depth0,alias3(((stack1 = blockParams[0][0]) != null ? stack1.products : stack1), depth0),{"name":"order.products","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</table>\n<div>\n";
	  ...
	  return "  <tbody>\n    <tr>\n      <td>"
	    ...
	    + "</td>\n      <td>$"
	    + alias1(__default(__webpack_require__(35)).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.price : depth0),{"name":"decimal","hash":{},"data":data}))
	    + "</td>\n    </tr>\n  </tbody>\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    return "<h2 class=\"text-center\">You have no orders. Happy Shopping!</h2>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n<h3>Order History</h3>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.orders : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
